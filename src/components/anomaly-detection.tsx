...
const anomalyData = [
  ...
  { date: "2024-07-04", sales: 35000, predicted: 50000 }, // Anomaly
...
function AnomalyItem({ title, description, impact, severity, date, icon }: AnomalyItemProps) {
    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Stay ahead of the curve with real-time anomaly detection. Our system identifies unusual patterns in your data, providing you with actionable insights to address potential issues and capitalize on opportunities.
        </p>
      </div>
